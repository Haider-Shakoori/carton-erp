    ...
    <div id="receipt-container">
        ...
        <div class="receipt-box" id="receipt-content">
            <div class="receipt-header">
                ...
                <div class="text-end">
                    <div class="receipt-title">{{ __('ui.exchange_purchase_receipt') }}</div>
                    <div class="receipt-date">{{ $purchase->created_at->format('F j, Y \a\t g:i A') }}</div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="amount-highlight text-danger">
                            - {{ number_format($purchase->base_amount, 0) }} {{ $purchase->baseCurrency->symbol }}
                        </div>
                    </div>

                    <div class="col-md-4 mb-3">
                        <div class="text-label">{{ __('ui.exchange_rate') }}</div>
                        <div class="text-value">{{ number_format($purchase->rate, 2) }}</div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="text-label">{{ __('ui.amount_received') }}</div>
                        <div class="amount-highlight">{{ number_format($purchase->target_amount, 0) }} {{ $purchase->targetCurrency->symbol }}</div>
                    </div>
                </div>
            </div>
