<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditCurrency">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title">Edit Currency</h5>
        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="{{ __('ui.close') }}"></button>
    </div>
    <div class="offcanvas-body">
        <form method="POST" id="editCurrencyForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input list="currency-codes" name="code" id="edit_code" class="form-control" placeholder="USD, AFN, RMB..." required>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="any" name="exchange_rate" id="edit_exchange_rate" class="form-control" required>
            </div>

            <div class="form-check mb-2">
                <input class="form-check-input" type="checkbox" name="is_default" id="edit_is_default">
                <label class="form-check-label" for="edit_is_default">{{ __('ui.set_default') }}</label>
            </div>

            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" name="is_active" id="edit_is_active">
                <label class="form-check-label" for="edit_is_active">{{ __('ui.active') }}</label>
            </div>

            <input type="hidden" name="flag" id="edit_flag_hidden">
            <img id="edit_flag_preview" src="/assets/flags/unknown.svg" width="30" height="20" class="mt-2">
