...
it('keeps the raw-material master limited to the approved materials including optional lamination stock', function () {
    $expected = [
        'Test Liner',
        'Fluting',
        'Kraft Liner',
...
it('seeds one arrived opening-stock purchase with all client materials available for production', function () {
    $this->seed(DatabaseSeeder::class);
